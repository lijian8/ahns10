...
{
	AHNS_DEBUG("ENTERED: ATT_drawBackground()");
...
void ATT_drawBackground_static() // NEEDS TO BE ADDED
{
...
{
	AHNS_DEBUG("ENTERED: ATT_drawHorizon()");
...
{
	AHNS_DEBUG("ENTERED: ATT_pitchMarkers_10DegInc()");
...
{
	AHNS_DEBUG("ENTERED: ATT_pitchMarkers_5DegInc()");
