...
//	struct js_event js;
	...
	jsReturn.axis = calloc(axes, sizeof(int));
	jsReturn.button = calloc(buttons, sizeof(char));
...
//		{
			jsRetVal.axs = axis[1]; // Axis is an integer array, holds all axis's information
//		}
	}
...
int main(int argc, char* argv[])
{
	...
	while (1)
	{
		...
		printf("%5d  %5d", jsRetVal.axs, jsRetVal.tbn);
	}
